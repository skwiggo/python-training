...
# whether a condition is true or false. If a condition is true the evaluation will return True,
...
# Comparing different values is usually done through what we call 'equality operators'.
# These are operators much like the mathematical ones seen in the last exercise. We will go through each one below:

# 1. The equals operator - "==" - used to compare the equality of two values.
# (e.g "duck" == "duck" will return True as both are strings with the same sequence of characters.)

# 2. The not equals operator - "!=" - used to check if two values are not equal to each other.
...
# 3. The greater than operator - ">" - used to check if the first value is greater than the second value.
# (e.g 6 > 3 will return True as both are integers and 6 is greater in value than 3)

# 4. The less than operator - "<" - used to check if the first value is less than the second value.
# (e.g 21 < 30 will return True as both are integers and 21 is less in value than 30)

# 5. The greater than or equal to operator - ">=" - used to check if the first value is greater
# than OR equal to the second value.
# (e.g 6 >= 3 will return True as both are integers and 6 is greater in value than 3,
# however 3 >= 3 will also return True as 3 and 3 are equal in value unlike 3 > 3 which will return False)

# 5. The less than or equal to operator - "<=" - used to check if the first value is less
# than OR equal to the second value.
# (e.g 21 <= 30 will return True as both are integers and 21 is less in value than 30,
...
# There is no coding in this exercise - instead we will look at a number of print statements using equality operators
